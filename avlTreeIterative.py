...
def insertIter(root, val):
    ...
    parents = []
    print("Inserting value: " + str(newNode.val))
...
if __name__ == '__main__':
    ...
    # Insertion Test case 3...
    # root = insertIter(root, 60)
    # root = insertIter(root, 35)
    # root = insertIter(root, 15)
    print("Level-order traversal after inserting all the nodes: ")
    printLevelOrder(root)
    print("\n")
    root = deleteIter(root, 35)
    print("After removing 35: ")
    printLevelOrder(root)
    print("\n")
